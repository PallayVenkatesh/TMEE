...
$wp_customize->add_section( 'theme_option_section_settings',
	array(
		'title'      => esc_html__( 'Layout Management', 'echo-magazine' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'home_page_content_status',
	array(
		'label'    => esc_html__( 'Enable Static Page Content', 'echo-magazine' ),
...
$wp_customize->add_control( 'enable_overlay_option',
	array(
		'label'    => esc_html__( 'Enable Banner Overlay', 'echo-magazine' ),
...
$wp_customize->add_control( 'global_layout',
	array(
		'label'    => esc_html__( 'Global Layout', 'echo-magazine' ),
		'section'  => 'theme_option_section_settings',
		'choices'               => array(
                'right-sidebar' => esc_html__( 'Content - Primary Sidebar', 'echo-magazine' ),
                'left-sidebar' => esc_html__( 'Primary Sidebar - Content', 'echo-magazine' ),
                'no-sidebar' => esc_html__( 'No Sidebar', 'echo-magazine' )
		    ),
		'type'     => 'select',
		'priority' => 170,
	)
...
$wp_customize->add_setting( 'excerpt_length_global',
	array(
		...
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'echo_magazine_sanitize_positive_integer',
	)
);
$wp_customize->add_control( 'excerpt_length_global',
	array(
		'label'    => esc_html__( 'Set Global Archive Length', 'echo-magazine' ),
		'section'  => 'theme_option_section_settings',
		'type'     => 'number',
		'priority' => 175,
...
$wp_customize->add_control( 'read_more_button_text',
    array(
        'label'    => esc_html__( 'Read More Button Text', 'echo-magazine' ),
        'section'  => 'theme_option_section_settings',
        'type'     => 'text',
        'priority' => 175,
    )
...
$wp_customize->add_control( 'archive_layout',
	array(
		'label'    => esc_html__( 'Archive Layout', 'echo-magazine' ),
		'section'  => 'theme_option_section_settings',
		'choices'               => array(
			'excerpt-only' => esc_html__( 'Excerpt Only', 'echo-magazine' ),
			'full-post' => esc_html__( 'Full Post', 'echo-magazine' ),
		    ),
		'type'     => 'select',
		'priority' => 180,
	)
...
$wp_customize->add_control( 'archive_layout_image',
	array(
		'label'    => esc_html__( 'Archive Image Alocation', 'echo-magazine' ),
		'section'  => 'theme_option_section_settings',
		'choices'               => array(
			'full' => esc_html__( 'Full', 'echo-magazine' ),
			'right' => esc_html__( 'Right', 'echo-magazine' ),
			'left' => esc_html__( 'Left', 'echo-magazine' ),
			'no-image' => esc_html__( 'No image', 'echo-magazine' )
		    ),
		'type'     => 'select',
		'priority' => 185,
	)
...
$wp_customize->add_control( 'single_post_image_layout',
	array(
		'label'    => esc_html__( 'Single Post/Page Image Alocation', 'echo-magazine' ),
		'section'  => 'theme_option_section_settings',
		'choices'               => array(
			'full' => esc_html__( 'Full', 'echo-magazine' ),
			'right' => esc_html__( 'Right', 'echo-magazine' ),
...
$wp_customize->add_section( 'pagination_section',
	array(
	'title'      => esc_html__( 'Pagination Options', 'echo-magazine' ),
	'priority'   => 110,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'pagination_type',
	array(
	'label'       => esc_html__( 'Pagination Type', 'echo-magazine' ),
	'section'     => 'pagination_section',
	'type'        => 'select',
	'choices'               => array(
		'default' => esc_html__( 'Default (Older / Newer Post)', 'echo-magazine' ),
		'numeric' => esc_html__( 'Numeric', 'echo-magazine' ),
	    ),
	'priority'    => 100,
	)
);
...
$wp_customize->add_section( 'footer_section',
	array(
	'title'      => esc_html__( 'Footer Options', 'echo-magazine' ),
	'priority'   => 130,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'number_of_footer_widget',
	array(
	'label'    => esc_html__( 'Number Of Footer Widget', 'echo-magazine' ),
	'section'  => 'footer_section',
	'type'     => 'select',
	'priority' => 100,
	'choices'               => array(
		0 => esc_html__( 'Disable footer sidebar area', 'echo-magazine' ),
		1 => esc_html__( '1', 'echo-magazine' ),
		2 => esc_html__( '2', 'echo-magazine' ),
		3 => esc_html__( '3', 'echo-magazine' ),
	    ),
	)
);
...
$wp_customize->add_control( 'copyright_text',
	array(
	'label'    => esc_html__( 'Footer Copyright Text', 'echo-magazine' ),
	'section'  => 'footer_section',
	'type'     => 'text',
	'priority' => 120,
	)
...
$wp_customize->add_section( 'breadcrumb_section',
	array(
	'title'      => esc_html__( 'Breadcrumb Options', 'echo-magazine' ),
	'priority'   => 120,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'breadcrumb_type',
	array(
	'label'       => esc_html__( 'Breadcrumb Type', 'echo-magazine' ),
	'description' => sprintf( esc_html__( 'Advanced: Requires %1$sBreadcrumb NavXT%2$s plugin', 'echo-magazine' ), '<a href="https://wordpress.org/plugins/breadcrumb-navxt/" target="_blank">','</a>' ),
	'section'     => 'breadcrumb_section',
	'type'        => 'select',
	'choices'               => array(
		'disabled' => esc_html__( 'Disabled', 'echo-magazine' ),
		'simple' => esc_html__( 'Simple', 'echo-magazine' ),
		'advanced' => esc_html__( 'Advanced', 'echo-magazine' ),
	    ),
	'priority'    => 100,
	)
);
...
$wp_customize->add_section( 'preloader_section',
	array(
	'title'      => esc_html__( 'Preloader Options', 'echo-magazine' ),
	'priority'   => 125,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'enable_preloader_option',
	array(
		'label'    => esc_html__( 'Enable Preloader', 'echo-magazine' ),
